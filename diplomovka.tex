...
\imgfigure[h][\textwidth/2]{gabika_holodeck}{The GearVR positioiinig system being used. One hedgehog beacon is used for headset tracking, the other one controlls the pointer. One of the static beacons is visible in the upper right corner.}
